            ...
            {{ csrf_field() }}
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" value="{{ $record->name }}" placeholder="Category Name">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="parent_id" id="parent_id" class="form-control">
                      ...
                      @foreach($category_list as $category)
                          <option value="{{ $category->id }}" {{ ($record->parent_id == $category->id)?'selected':'' }}>{{$category->name}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
