            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                  <a href="{!! URL::route('country_edit',$country->id) !!}"  class="btn btn-info"><i class="fa fa-edit"></i></a>
                  <a onclick="return confirm('Delete! Are you sure')" href="{!! URL::route('country_delete',$country->id) !!}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                @endforeach
                <tr>
                <td colspan="4">{{ $country_list->links() }}</td>
                </tr>
                @else
                <tr>
