            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{ $state->status }}</td>
                  <td>
                  <a href="{!! URL::route('state_edit',$state->id) !!}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                  <a onclick="return confirm('Delete! Are you sure')" href="{!! URL::route('state_delete',$state->id) !!}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                @endforeach
                @else
